                                                    ...
                                                    if parameter1 == "Name":
                                                        ...
                                                        while True:
                                                            ...
                                                            for g1 in range(0, len(option4)):
                                                                print(option4[g1])
                                                            chose1 = input("\nPlease choose to set the element\n")
                                                        ...
                                                        while True:
                                                            ...
                                                            if chose1 == "Single":
                                                                ...
                                                                element_array = list()
                                                                number = input("\nPlease set the number of element\n")
                                                                for i in range(int(number)):
                                                                    n = input("Please insert the element:\n")
                                                                    element_array.append(str(n))
